...
public abstract class EntityStacked extends Entity {
    ...
    protected static final EntityDataAccessor<Byte[]> STACK = SynchedEntityData.defineId(EntityStacked.class, Services.ENTITY_DATA.getStackSerializer());
    ...
    public abstract void moreData(SynchedEntityData.Builder builder);

    @Override
    protected void defineSynchedData(SynchedEntityData.Builder builder) {
        builder.define(STACK, new Byte[0]);
        moreData(builder);
    }
